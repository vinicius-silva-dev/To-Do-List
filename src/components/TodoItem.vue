        ...
        <div class="w-full">
          ...
          <div class="ml-auto flex items-center justify-center">
            <button 
              ...
              >
                <path
                  d="M19 7L18.1327 19.1425C18.0579 20.1891 17.187 21 16.1378 21H7.86224C6.81296 21 5.94208 20.1891 5.8673219.1425L5 7M10 11V17M14 11V17M15 7V4C15 3.44772 14.5523 3 14 3H10C9.44772 3 9 3.44772 9 4V7M4 7H20"
                  stroke-width="2"
        ...
        <div class="flex items-center px-4 py-3 border-b border-gray-400 last:border-b-0">
          ...
          <div class="w-full">
            <input
              ...
              value="Estudar Vue 3"
              readonly
              class="line-through bg-gray-300 placeholder-gray-500 text-gray-700 font-light focus:outline-none block 
w-full appearance-none leading-normal mr-3"
        ...
        <div class="ml-auto flex items-center justify-center">
          <button class="focus:outline-none">
            ...
            >
              <path
                d="M19 7L18.1327 19.1425C18.0579 20.1891 17.187 21 16.1378 21H7.86224C6.81296 21 5.94208 20.1891 5.86732 
